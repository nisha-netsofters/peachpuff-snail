...
const VerticalLayout = (props) => {
  ...
  useEffect(() => {
    if (menuVisibility && windowWidth < 1560) {
  ...
  return (
    <div
      className={classnames(
        ...
        {
          // Modern Menu
          "vertical-menu-modern": windowWidth >= 1560,
          "menu-collapsed": menuCollapsed && windowWidth >= 1560,
          "menu-expanded": !menuCollapsed && windowWidth > 1560,

          // Overlay Menu
          "vertical-overlay-menu": windowWidth < 1560,
          "menu-hide": !menuVisibility && windowWidth < 1560,
          "menu-open": menuVisibility && windowWidth < 1560,
        }
      )}
    ...
    >
      ...
      {themeConfig.layout.scrollTop === true && windowWidth > 600 ? (
