...
const JOB_MATCH_OPTIONS = [
  ...
  { label: "Mobile", value: "mobile" },
  { label: "Email", value: "email" },
  { label: "Candidate City", value: "city" },
  { label: "Job Title", value: "jobTitle" },
  { label: "Industry", value: "jobIndustry" },
  { label: "Job Category", value: "jobCategory" },
  { label: "Job Sub Category", value: "jobSubCategory" },
  { label: "Job Category - Job Sub Category", value: "jobCategory_jobSubCategory" },
  ...
  { label: "Job Area", value: "jobArea" },
  { label: "Job Location", value: "jobLocation" },
  { label: "Employment Type", value: "jobEmploymentType" },
  { label: "Qualification", value: "jobQualification" },
...
const MATCH_TO_PLACEHOLDER = {
  ...
  jobCategory_jobSubCategory: "{{jobCategory_jobSubCategory}}",
  job_category_sub_category: "{{jobCategory_jobSubCategory}}",
