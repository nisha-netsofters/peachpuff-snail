...
import Basic from "../../components/Forms/PublicClient/Basic";
...
const PublicClient = () => {
  const publicClient = useSelector((state) => state.client);
