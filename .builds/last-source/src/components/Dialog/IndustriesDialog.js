...
import IndustriesForm from "../Forms/Industries/Industries";
import JobCat from "../Forms/JobCate/JobCat";
import Loader from "./Loader";

const IndustriesDialog = ({
  industriesHandler = () => {},
  industriesCategory,
  ...
  const handleChange = (e) => {
    if (e?.target?.id === undefined) {
      setIndustriesCategory({ ...industriesCategory, [e.id]: e.value });
    } else {
      setIndustriesCategory({
        ...industriesCategory,
