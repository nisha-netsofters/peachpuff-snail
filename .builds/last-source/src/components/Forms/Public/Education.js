...
const Education = ({setCandidate, candidate}) => {
                        ...
                        <Col md={6} xs={12}>
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                setFieldValue(`education.${index}.institute`, e.target.value)
                              }}
                            />
                          </div>
                        </Col>
                        <Col md={6} xs={12}>
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                setFieldValue(`education.${index}.department`, e.target.value)
                              }}
                            />
                          </div>
                        </Col>
                        <Col md={6} xs={12}>
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) => {
                                setFieldValue(`education.${index}.degree`, e.target.value)
                              }}
                            />
                          </div>
                        </Col>
                        <Col md={6} xs={12}>
                          <div>
                            ...
                            <Select
                                ...
                                onChange={(e) => {
                                    setFieldValue(`education.${index}.english`, e.value)
                        ...
                        <Col md={6} xs={12}>
                          <div>
                            ...
                            <Input
                              ...
                              type="number"
                              value={values?.education[index]?.eductionDuration}
                              onChange={(e) => {
                                setFieldValue(`education.${index}.eductionDuration`, e.target.value)
                              }
                              }
                            />
                          </div>
