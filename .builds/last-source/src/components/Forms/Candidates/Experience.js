...
const Expereince = ({ candidate, setCandidate, update }) => {
  return (
    <div>
      <Formik initialValues={initialValues}>
        {({ values, setFieldValue }) => {
          useEffect(() => {
            if (candidate?.experience?.length > 0 && update === true) {
              values.experience = []
              values.experience.pop(0)
              candidate?.experience?.map((ele) => {
                initialValues.experience.push(ele)
              })
            } else {
              values.experience = [
                {
                          ...
                          <Col md={2} xs={6} sm={6} style={{ display: "flex", justifyContent: "right" }} >
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                } else alert("Please FillUp atleast One Experience Details")
                          ...
                          <Col lg={6} xs={12} xl={4}>
                            <div>
                              ...
                              <Input
                                ...
                                value={values?.experience[index]?.companyMobile}
                                // value={searchTerm}
                                onChange={(e) => {
                                  setFieldValue(
                                    `experience.${index}.companyMobile`,
                                    e.target.value
                                  )
                                }}
                              />
                          ...
                          <Col lg={6} xs={12} xl={4}>
                            <div>
                              ...
                              <Input
                                ...
                                type="text"
                                value={
                                  values?.experience[index]?.companyAddress
                                }
                                // value={searchTerm}
                                onChange={(e) => {
                                  setFieldValue(
                                    `experience.${index}.companyAddress`,
                                    e.target.value
                                  )
                                }}
                              />
